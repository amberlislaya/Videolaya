...
<div className="flex h-5 items-center">
        {pageName !== "video" && (
<div className="flex md:hidden md:mr-6 cursor-pointer items-center justify-center h-10 w-10 rounded-full hover:bg-[#130117]/[0.6]"
...
<button className="w-[40px] md:w-[60px] h-8 md:h-10 flex items-center justify-center border border-l-0 border-[#303030] rounded-r-3xl bg-[#08030a]/[0.1]"
...
<div className="flex items-center justify-center h-10 w-10 rounded-full hover:bg-[#130117]/[0.6]">
